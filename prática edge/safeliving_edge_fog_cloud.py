...
LIMIAR_GAS_PPM = 300  # acima disso, o sensor de fumaça/gás considera vazamento
...
class DispositivoResidencial:
    ...
    def gerar_leitura(self, ciclo_atual):
        ...
        if self.tipo == "camera_garagem":
            ...
            # Evento raro (~5% de chance por ciclo): concentração de gás/fumaça
    ...
    # -------- NOVO MÓDULO: sensor de fumaça/gás na cozinha --------
        ...
        if nivel_gas is not None and nivel_gas >= LIMIAR_GAS_PPM:
            print(f"    [CASA #{self.casa_numero}] AÇÃO AUTÔNOMA (ms): sensor de fumaça/gás "
                  ...
                  f"-> gateway corta a válvula de gás e aciona a sirene, sem esperar a Fog/Cloud.")
